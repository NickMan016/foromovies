import { genre } from "../../../../interfaces/MovieDBInterfaces";
            ...
            <div className="relative h-[500px] mb-[60px]">
                ...
                <div className="absolute top-1/4 left-[10%] w-4/5">
                    ...
                    <div className="block w-full mt-20">
                        <p className="text-[1.75rem] leading-normal font-bold">{title}</p>
                        <p className="original__post text-[1.2rem] leading-normal">Titulo Original: {originalTitle}</p>
                        ...
                        <p className="mt-1 leading-normal">{synopsis}</p>
                    </div>
                </div>
            </div>
        </div>
